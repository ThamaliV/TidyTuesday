...
```{r saving the plot a}
ggsave(here("figures", "plot_a.pdf"),plot_a,
...
plot_b <- ditch_nhl %>%
          ...
          labs(title= " Height distribution of Canadian NHL players with their position type",                                      subtitle= "Defensemen are much heigher than forwards and goalies. In Nova Scotia, the heights of the goalies are considerably low.  ", 
...
```{r saving the plot b}
ggsave(here("figures", "plot_b.pdf"),plot_b,
       width= 190, height=120, units= "mm")
```
